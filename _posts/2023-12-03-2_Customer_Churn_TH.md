---
title:  "[🇹🇭 Thai] Bank customer churn prediction (Classification, Random Forest)"
layout: post
---
...
จากข้อมูลทั้ง [ยอดเงินในบัญชีโดยเฉลี่ยตามประเทศของลูกค้า](#bullet_a) และ [ายได้โดยเฉลี่ยตามประเทศของลูกค้า](#bullet_b) ข้างต้นทำให้ทราบว่า:
