...
1. งานชิ้นนี้ได้ทำการวิเคราะห์ข้อมูล Exploratory Data Analysis (EDA) เพื่อให้ได้ความเข้าใจเชิงลึก (insights) โดยสรุปคือ
    ...
    - ยิ่งลูกค้าใช้บริการหลายตัวยิ่งมีโอกาสเลิกใช้ธนาคาร ซึ่งขัดต่อ "ความรู้สึก" คือหากใช้บริการหลายตัวยิ่ง "ไม่น่าจะ" เลิกใช้ธนาคาร แต่ข้อมูลที่ได้นี้กลับตรงกันข้าม จึงสมควรที่จะศึกษาบริบทอื่นเพิ่มเติม (investigate) เพื่อให้ได้ความเข้าใจเพิ่มขึ้น
